...
pub const Relocation = struct {
    ...
    pub const Sparc = enum(u16) {
        ...
        disp16 = elf.R_SPARC_DISP1,
        disp32 = elf.R_SPARC_DISP3,
        disp64 = elf.R_SPARC_DISP64,
        disp8 = elf.R_SPARC_DISP,
        ...
        wdisp22 = elf.R_SPARC_WDISP2,
        wdisp30 = elf.R_SPARC_WDISP3,
        wplt30 = elf.R_SPARC_WPLT30,
    };

    pub const TileGx = enum(u16) {
        @"16" = elf.R_TILEGX_16,
...
pub const AlphaSectionFlags = enum(u32) {
    gprel = elf.SHF_ALPHA_GPREL,
};

pub const ArmSectionFlags = enum(u32) {
    comdef = elf.SHF_ARM_COMDEF,
    entrysect = elf.SHF_ARM_ENTRYSECT,
};

pub const GnuSectionFlags = enum(u32) {
    retain = elf.SHF_GNU_RETAIN,
};

pub const Ia64SectionFlags = enum(u32) {
    norecov = elf.SHF_IA_64_NORECOV,
    short = elf.SHF_IA_64_SHORT,
};

pub const MipsSectionFlags = enum(u32) {
...
pub const PariscSectionFlags = enum(u32) {
...
pub const MipsSectionIndex = enum(u16) {
...
pub const PariscSectionIndex = enum(u16) {
...
pub const Ia64SectionType = enum(u32) {
    ext = elf.SHT_IA_64_EXT,
    unwind = elf.SHT_IA_64_UNWIND,
};

pub const MipsSectionType = enum(u32) {
...
pub const ArmSymbolType = enum(u8) {
    @"16bit" = elf.STT_ARM_16BIT,
    tfunc = elf.STT_ARM_TFUNC,
};

pub const SymbolInfo = enum(u32) {
...
pub const VersionDefinition = enum(u8) {
    current = elf.VER_DEF_CURRENT,
    none = elf.VER_DEF_NONE,
    num = elf.VER_DEF_NUM,
};

pub const VersionFlags = enum(u16) {
...
pub const VersionNeedformat = enum(u16) {
